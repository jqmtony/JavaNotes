...
public class insertCar implements Serializable{
	 ...
	 */
	// 添加汽车
	public insertCar(int id, String car_number, int brand_id, String model, String color, int category_id, String t_comments, double price, double rent, int status, int useable) {
		super();
		this.id = id;
