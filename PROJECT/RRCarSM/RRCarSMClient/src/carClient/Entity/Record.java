...
import carClient.Utils.DateUtils;
...
//		System.out.println("订单编号\t车牌号\t简介\t品牌名\t类型名\t每日租金\t总金额\t出借日期\t\t归还日期");
		/*return record_id +"\t"+ car_number +"\t"+ t_comments +"\t"+ brand_name+"\t"+ category_name+"\t"+ rent +"\t"+ payment +"\t"+ DateUtils.formatDate(start_date) +"\t"+ DateUtils.formatDate(return_date);*/
